...
const WELCOME_T: Record<Lang, {
  ...
  en: {
    ...
    step3Desc: 'Up to 36 biomarkers analyzed with your personal Health Engine score.',
  ...
  de: {
    ...
    step3Desc: 'Bis zu 36 Biomarker analysiert mit deinem persönlichen Health Engine Score.',
  ...
  fr: {
    ...
    step3Desc: "Jusqu'à 36 biomarqueurs analysés avec votre score Health Engine personnel.",
  ...
  es: {
    ...
    step3Desc: 'Hasta 36 biomarcadores analizados con tu puntuación Health Engine personal.',
  ...
  it: {
    ...
    step3Desc: 'Fino a 36 biomarcatori analizzati con il tuo punteggio Health Engine personale.',
