...
const copy = {
  de: {
    text: 'Diese Website verwendet Plausible Analytics – eine datenschutzfreundliche, cookielose Analyse-Lösung ohne personenbezogene Daten.',
    link: 'Datenschutz',
    button: 'Verstanden',
  },
  en: {
    text: 'This site uses Plausible Analytics — privacy-friendly, cookieless, no personal data collected.',
    link: 'Privacy Policy',
    button: 'Got it',
  },
};
...
export default function CookieBanner() {
  ...
  useEffect(() => {
    ...
    const storedLang = localStorage.getItem('evida-lang');
