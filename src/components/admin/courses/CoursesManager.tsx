    ...
    <div className="p-8">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <button onClick={openCreate}
          ...
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg> New Course
        </button>
      </div>
      ...
      <div className="rounded-xl border border-[#0e393d]/10 bg-white overflow-hidden shadow-sm">
        <table className="w-full text-sm">
          ...
          <tbody className="divide-y divide-[#0e393d]/5">
            {sorted.length === 0 && (
              <tr><td colSpan={7} className="px-4 py-12 text-center"><div className="text-sm text-[#1c2a2b]/40">No courses found.</div></td></tr>
            )}
            {sorted.map((c) => (
          ...
          <div className="fixed inset-y-0 right-0 z-50 flex w-full max-w-2xl flex-col bg-white shadow-2xl rounded-l-2xl">
            ...
            <div className="flex items-center justify-between border-b border-[#0e393d]/10 px-6 py-4 shrink-0">
              ...
              <div className="flex items-center gap-3">
                ...
                <button onClick={closePanel} className="p-1.5 rounded-lg text-[#1c2a2b]/40 hover:bg-[#0e393d]/5 hover:text-[#1c2a2b] transition">
