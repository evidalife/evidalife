...
export default function SiteSettingsManager() {
  ...
  if (loading) {
    return (
      <PageShell title="Site Settings" description="Manage company information displayed across the website">
  ...
  return (
    <PageShell
      title="Site Settings"
      description="Company info used on the contact page, footer, legal pages, and more"
      action={
        <button
          onClick={handleSave}
