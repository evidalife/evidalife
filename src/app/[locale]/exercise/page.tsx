      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 text-center">
        <div className="max-w-sm">
          ...
          <h1 className="font-serif text-4xl text-[#0e393d] mb-4">
            {locale === 'de' ? 'Bewegung' : 'Exercise'}
          </h1>
          <p className="text-[#1c2a2b]/60 text-base leading-relaxed mb-8">
            {locale === 'de'
              ? 'Bewegungstracking und personalisierte Trainingspläne für deine Longevity – bald verfügbar.'
              : 'Exercise tracking and personalised training plans for your longevity — coming soon.'}
          </p>
