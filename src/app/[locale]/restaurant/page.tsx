    ...
    <div className="min-h-screen bg-[#fafaf8] flex flex-col">
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 pt-28 text-center">
        <div className="max-w-sm">
          ...
          <h1 className="font-serif text-4xl text-[#0e393d] mb-4">Restaurant</h1>
          <p className="text-[#1c2a2b]/60 text-base leading-relaxed mb-8">
            {locale === 'de'
              ? 'Empfehlungen für pflanzenbasierte Restaurants in deiner Nähe – bald verfügbar.'
              : 'Recommendations for plant-based restaurants near you — coming soon.'}
          </p>
