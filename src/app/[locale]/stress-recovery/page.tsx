    ...
    <div className="min-h-screen bg-[#fafaf8] flex flex-col">
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 pt-28 text-center">
        <div className="max-w-sm">
          ...
          <h1 className="font-serif text-4xl text-[#0e393d] mb-4">Stress & Recovery</h1>
          <p className="text-[#1c2a2b]/60 text-base leading-relaxed mb-8">
            {locale === 'de'
              ? 'HRV-Tracking, Atemübungen und Erholungsmassnahmen für optimale Regeneration – bald verfügbar.'
              : 'HRV tracking, breathing exercises, and recovery tools for optimal regeneration — coming soon.'}
          </p>
