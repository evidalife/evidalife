      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 pt-28 text-center">
        <div className="max-w-sm">
          ...
          <h1 className="font-serif text-4xl text-[#0e393d] mb-4">
            {locale === 'de' ? 'Meine Bestellungen' : 'My Orders'}
          </h1>
          <p className="text-[#1c2a2b]/60 text-base leading-relaxed mb-8">
            {locale === 'de'
              ? 'Bestellhistorie und Statusverfolgung – bald in deinem persönlichen Dashboard.'
              : 'Order history and status tracking — coming soon in your personal dashboard.'}
          </p>
