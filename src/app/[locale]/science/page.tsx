  ...
  return (
    <div className="min-h-screen bg-[#fafaf8] flex flex-col">
      ...
      <main className="flex-1">
        ...
        {/* ── Evidence Pyramid ── */}
        <section className="w-full bg-white border-b border-[#0e393d]/10 py-16">
        ...
        {/* ── Disease table ── */}
        <section className="w-full border-b border-[#0e393d]/10 py-16">
          <div className="max-w-[1060px] mx-auto px-8 md:px-12">
        ...
        <section className="w-full bg-white border-y border-[#0e393d]/10 py-16">
          <div className="max-w-[1060px] mx-auto px-8 md:px-12">
