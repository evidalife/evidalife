      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 text-center">
        <div className="max-w-sm">
          ...
          <h1 className="font-serif text-4xl text-[#0e393d] mb-4">
            {locale === 'de' ? 'Wie starten' : 'How to Start'}
          </h1>
          <p className="text-[#1c2a2b]/60 text-base leading-relaxed mb-8">
            {locale === 'de'
              ? 'Dein Einstieg in eine evidenzbasierte, pflanzenbasierte Ernährung – bald verfügbar.'
              : 'Your guide to evidence-based, plant-based nutrition — coming soon.'}
          </p>
