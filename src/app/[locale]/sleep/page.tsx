      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 pt-28 text-center">
        <div className="max-w-sm">
          ...
          <h1 className="font-serif text-4xl text-[#0e393d] mb-4">
            {locale === 'de' ? 'Schlaf' : 'Sleep'}
          </h1>
          <p className="text-[#1c2a2b]/60 text-base leading-relaxed mb-8">
            {locale === 'de'
              ? 'Schlaftracking und evidenzbasierte Empfehlungen für erholsamen Schlaf – bald verfügbar.'
              : 'Sleep tracking and evidence-based recommendations for restorative sleep — coming soon.'}
          </p>
