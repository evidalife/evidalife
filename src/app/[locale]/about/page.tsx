      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 text-center">
        <div className="max-w-sm">
          ...
          <p className="text-[#1c2a2b]/60 text-base leading-relaxed mb-8">
            {locale === 'de'
              ? 'Unsere Mission: evidenzbasierte Gesundheit für alle zugänglich machen. Mehr bald.'
              : 'Our mission: making evidence-based health accessible to everyone. More coming soon.'}
          </p>
