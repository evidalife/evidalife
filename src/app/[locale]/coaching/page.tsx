...
const T: Record<Lang, { comingSoon: string; title: string; desc: string; cta: string }> = {
  de: {
    ...
    title: 'Coaching',
    desc: 'Persönliches Gesundheitscoaching mit zertifizierten Longevity-Experten – bald verfügbar.',
    cta: '← Zur Startseite',
  },
  en: {
    comingSoon: 'Coming soon',
    title: 'Coaching',
    desc: 'Personal health coaching with certified longevity experts — coming soon.',
    cta: '← Back to home',
  },
  fr: {
    comingSoon: 'Bientôt disponible',
    title: 'Coaching',
    desc: 'Coaching de santé personnel avec des experts en longévité certifiés — bientôt disponible.',
    cta: '← Retour à l\'accueil',
  },
  es: {
    comingSoon: 'Próximamente',
    title: 'Coaching',
    desc: 'Coaching de salud personal con expertos en longevidad certificados — próximamente.',
    cta: '← Volver al inicio',
  },
  it: {
    comingSoon: 'Prossimamente',
    title: 'Coaching',
    desc: 'Coaching sanitario personale con esperti di longevità certificati — prossimamente.',
    cta: '← Torna alla home',
  },
};
